# This is a fixed version of example2 from nanogui examples:
# https://raw.githubusercontent.com/wjakob/nanogui/master/python/example2.py
...
gui.add_color_variable("Color", *make_accessors("colvar")).set_final_callback(cp_final_cb)
